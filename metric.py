...
@Metric.register("customfbeta")
class CustomFBetaMeasure(Metric):
    ...
    def __call__(self,
        ...
        # print("true_positive_sum: ", self._true_positive_sum)
        # print("pred_sum: ", self._pred_sum)
        # print("true_sum: ", self._true_sum)
        # print("total_sum: ", self._total_sum)
    ...
    def get_metric(self,
        ...
        if self._labels is not None:
            tp_sum = self._true_positive_sum[self._labels]
            pred_sum = self._pred_sum[self._labels]
            true_sum = self._true_sum[self._labels]
